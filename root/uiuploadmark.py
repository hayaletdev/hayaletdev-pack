...
class MarkItem(ui.ListBoxEx.Item):
	...
	def SetSize(self, width, height):
		if localeInfo.IsARABIC():
			ui.ListBoxEx.Item.SetSize(self, 20 + len(self.textLine.GetText()) + 4, height)
		else:
	...
	def __Load(self):
		...
		try:
			...
			if localeInfo.IsVIETNAM():
				pyScrLoader.LoadScriptFile(self, uiScriptLocale.LOCALE_COMMON_UISCRIPT_PATH + "MarkListWindow.py")
			else:
