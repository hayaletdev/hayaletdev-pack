...
class SelectCharacterWindow(ui.Window):
	...
	def Open(self):
		if not self.__LoadBoardDialog(uiScriptLocale.LOCALE_COMMON_UISCRIPT_PATH + "selectcharacterwindow.py"):
			import dbg
	...
	def OnUpdate(self):
		...
		if -1 != self.startIndex:
			...
			## Temporary
			## BackGroundLoading 이 지원 될때까지 임시로..
