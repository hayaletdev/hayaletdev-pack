...
class CreateCharacterWindow(ui.Window):
	...
	def __init__(self, stream):
		self.STAT_DESCRIPTION = {
			self.STAT_CON : localeInfo.STAT_TOOLTIP_CON,
			self.STAT_INT : localeInfo.STAT_TOOLTIP_INT,
			self.STAT_STR : localeInfo.STAT_TOOLTIP_STR,
			self.STAT_DEX : localeInfo.STAT_TOOLTIP_DEX,
		}
	...
	def Open(self):
		...
		try:
			...
			pythonScriptLoader.LoadScriptFile(dlgBoard, uiScriptLocale.LOCALE_COMMON_UISCRIPT_PATH + "createcharacterwindow.py")
