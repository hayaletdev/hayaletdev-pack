...
def DefineSkillIndexDict():
	...
	SUPPORT_SKILL_INDEX_LIST = (
		player.SKILL_INDEX_COMBO,
		player.SKILL_INDEX_FISHING,
		player.SKILL_INDEX_TONGSOL,
		player.SKILL_INDEX_MINING,
		player.SKILL_INDEX_MAKING,
		player.SKILL_INDEX_POLYMORPH,
		0,
		0,
		player.SKILL_INDEX_RIDING,
		player.SKILL_INDEX_SUMMON,
		0,
		0,
	)

	# NEW_678TH_SKILL_ENABLE = localeInfo.IsYMIR()
	if NEW_678TH_SKILL_ENABLE and app.ENABLE_CONQUEROR_LEVEL:
		SKILL_INDEX_DICT = {
			JOB_WARRIOR : {
				1 : (1, 2, 3, 4, 5, 6, 0, 0, 176, 0, 137, 0, 138, 0, 139, 0,),
				2 : (16, 17, 18, 19, 20, 21, 0, 0, 176, 0, 137, 0, 138, 0, 139, 0,),
				"SUPPORT" : SUPPORT_SKILL_INDEX_LIST,
			},
			JOB_ASSASSIN : {
				1 : (31, 32, 33, 34, 35, 36, 0, 0, 177, 0, 137, 0, 138, 0, 139, 0, 140,),
				2 : (46, 47, 48, 49, 50, 51, 0, 0, 178, 0, 137, 0, 138, 0, 139, 0, 140,),
				"SUPPORT" : SUPPORT_SKILL_INDEX_LIST,
			},
			JOB_SURA : {
			...
			JOB_SHAMAN : {
				1 : (91, 92, 93, 94, 95, 96, 0, 0, 181, 0, 137, 0, 138, 0, 139, 0,),
				2 : (106, 107, 108, 109, 110, 111, 0, 0, 182, 0, 137, 0, 138, 0, 139, 0,),
				"SUPPORT" : SUPPORT_SKILL_INDEX_LIST,
			},
			JOB_WOLFMAN : { # TODO: 수인족 스킬 등록
				1 : (170, 171, 172, 173, 174, 175, 0, 0, 183, 0, 137, 0, 138, 0, 139, 0,),
				2 : (170, 171, 172, 173, 174, 175, 0, 0, 183, 0, 137, 0, 138, 0, 139, 0,),
				"SUPPORT" : SUPPORT_SKILL_INDEX_LIST,
			},
		}
	elif NEW_678TH_SKILL_ENABLE:
		SKILL_INDEX_DICT = {
			JOB_WARRIOR : {
	...
	if app.ENABLE_CONQUEROR_LEVEL and (app.ENABLE_PARTY_PROFICY or app.ENABLE_PARTY_INSIGHT):
		SUPPORT_SKILL_INDEX_LIST = (0, 0,
			player.SKILL_INDEX_TONGSOL, # 121
			player.SKILL_INDEX_INSIGHT, # 134
			player.SKILL_INDEX_ROLE_PROFICIENCY, # 133
			player.SKILL_INDEX_POLYMORPH, # 129
			player.SKILL_INDEX_RIDING, # 130
			player.SKILL_INDEX_SUMMON, # 131
			player.SKILL_INDEX_FISHING, # 123
			player.SKILL_INDEX_MINING, # 124
			player.SKILL_INDEX_COMBO, # 122
			player.SKILL_INDEX_AUTO_ATTACK, # 132
			player.SKILL_INDEX_HIT, # 246
			0,
			0,
			0,
			0,
	...
	elif app.ENABLE_PARTY_PROFICY or app.ENABLE_PARTY_INSIGHT:
		SUPPORT_SKILL_INDEX_LIST = (0, 0,
			player.SKILL_INDEX_TONGSOL,
			player.SKILL_INDEX_INSIGHT,
			player.SKILL_INDEX_ROLE_PROFICIENCY,
			player.SKILL_INDEX_POLYMORPH,
			player.SKILL_INDEX_RIDING,
			player.SKILL_INDEX_SUMMON,
			player.SKILL_INDEX_FISHING,
	...
	SKILL_INDEX_DICT[JOB_WARRIOR].update({ "SUPPORT" : SUPPORT_SKILL_INDEX_LIST, })
	SKILL_INDEX_DICT[JOB_ASSASSIN].update({ "SUPPORT" : SUPPORT_SKILL_INDEX_LIST, })
	SKILL_INDEX_DICT[JOB_SURA].update({ "SUPPORT" : SUPPORT_SKILL_INDEX_LIST, })
	SKILL_INDEX_DICT[JOB_SHAMAN].update({ "SUPPORT" : SUPPORT_SKILL_INDEX_LIST, })
	SKILL_INDEX_DICT[JOB_WOLFMAN].update({ "SUPPORT" : SUPPORT_SKILL_INDEX_LIST, })
...
def RegisterSkill(race, group, empire = 0):
	...
	if SKILL_INDEX_DICT.has_key(job):
		...
		if SKILL_INDEX_DICT[job].has_key(group):
			...
			for i in xrange(len(activeSkillList)):
				...
				if i != 6 and i != 7:
					if app.ENABLE_CONQUEROR_LEVEL and i == 8:
						if not player.GetStatus(player.POINT_CONQUEROR_LEVEL):
							player.SetSkill(i + 1, 0)
							continue
	...
	if 0 != empire:
		...
		for i in xrange(len(languageSkillList)):
			if app.ENABLE_CONQUEROR_LEVEL or app.ENABLE_PARTY_PROFICY or app.ENABLE_PARTY_INSIGHT:
...
def __InitData():
	...
	chrmgr.RegisterCacheEffect(chrmgr.EFFECT_BUFF_ITEM_5, "", "d:/ymir work/effect/etc/buff/buff_item5.mse")

	if app.ENABLE_ACCE_COSTUME_SYSTEM:
		chrmgr.RegisterCacheEffect(chrmgr.EFFECT_ACCE_SUCESS_ABSORB, "", "d:/ymir work/effect/etc/buff/buff_item6.mse")
		chrmgr.RegisterCacheEffect(chrmgr.EFFECT_ACCE_EQUIP, "", "d:/ymir work/effect/etc/buff/buff_item7.mse")

	#부활절 캔디(71188) 착용순간 발동 이펙트
	chrmgr.RegisterCacheEffect(chrmgr.EFFECT_EASTER_CANDY_EQIP, "", "d:/ymir work/effect/etc/buff/buff_item8.mse")
	...
	chrmgr.RegisterEffect(chrmgr.EFFECT_THUNDER_AREA, "", "D:/ymir work/effect/monster/light_emissive3.mse")
	chrmgr.RegisterEffect(chrmgr.EFFECT_THUNDER, "", "D:/ymir work/effect/monster/yellow_tigerman_24_1.mse")
	chrmgr.RegisterEffect(chrmgr.EFFECT_HEAL, "", "D:/ymir work/pc/shaman/effect/jeongeop_2.mse")
	chrmgr.RegisterEffect(chrmgr.EFFECT_CAPE_OF_COURAGE, "", "D:/ymir work/effect/etc/buff/buff_item9.mse")

	#if app.ENABLE_2016_VALENTINE:
	chrmgr.RegisterEffect(chrmgr.EFFECT_CHOCOLATE_PENDANT, "", "D:/ymir work/effect/etc/buff/buff_item10.mse")

	#if app.ENABLE_PEPSI_EVENT:
	chrmgr.RegisterEffect(chrmgr.EFFECT_PEPSI_EVENT, "", "D:/ymir work/effect/etc/buff/buff_item11.mse")

	if app.ENABLE_GUILD_DRAGONLAIR_SYSTEM:
		chrmgr.RegisterEffect(chrmgr.EFFECT_DRAGONLAIR_STONE_UNBEATABLE_1, "", "d:/ymir work/effect/monster2/redd_moojuk.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_DRAGONLAIR_STONE_UNBEATABLE_2, "", "d:/ymir work/effect/monster2/redd_moojuk_blue.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_DRAGONLAIR_STONE_UNBEATABLE_3, "", "d:/ymir work/effect/monster2/redd_moojuk_green.mse")

	if app.ENABLE_DEFENSE_WAVE:
		chrmgr.RegisterEffect(chrmgr.EFFECT_DEFENSE_WAVE_LASER, "", "d:/ymir work/effect/monster2/defense_mini_laser.mse")

	if app.ENABLE_BALANCE_IMPROVING:
		chrmgr.RegisterEffect(chrmgr.EFFECT_FEATHER_WALK, "", "d:/ymir work/effect/hit/gyeonggong_boom.mse")

	#if app.ENABLE_BATTLE_FIELD:
	chrmgr.RegisterEffect(chrmgr.EFFECT_BATTLE_POTION, "", "D:/ymir work/effect/etc/buff/buff_item12.mse")

	chrmgr.RegisterEffect(chrmgr.EFFECT_BUFF_ITEM_13, "", "D:/ymir work/effect/etc/buff/buff_item13.mse")
	chrmgr.RegisterEffect(chrmgr.EFFECT_BUFF_ITEM_14, "", "D:/ymir work/effect/etc/buff/buff_item14.mse")

	#if app.ENABLE_AI_FLAG_REFLECT:
	chrmgr.RegisterEffect(chrmgr.EFFECT_REFLECT, "", "D:/ymir work/effect/hit/blow_4/blow_4_ref.mse")
	...
	if app.ENABLE_FLOWER_EVENT:
		chrmgr.RegisterEffect(chrmgr.EFFECT_FLOWER_EVENT, "", "d:/ymir work/effect/etc/buff/buff_item15_flower.mse")

	if app.ENABLE_GEM_SYSTEM:
		chrmgr.RegisterEffect(chrmgr.EFFECT_GEM_PENDANT, "", "d:/ymir work/effect/etc/buff/buff_item16.mse")

	if app.ENABLE_SUMMER_EVENT_ROULETTE:
		chrmgr.RegisterEffect(chrmgr.EFFECT_SPECIAL_ROULETTE, "", "d:/ymir work/effect/npc2/altar_blood_eff.mse")

	if app.ENABLE_SNOWFLAKE_STICK_EVENT:
		chrmgr.RegisterEffect(chrmgr.EFFECT_USE_SNOWFLAKE_STICK, "", "D:/ymir work/effect/etc/buff/buff_snowflower.mse")
...
def __LoadGameEffect():
	...
	chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+chr.AFFECT_POISON, "Bip01", "d:/ymir work/effect/hit/blow_poison/poison_loop.mse") ## 중독
	chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+chr.AFFECT_BLEEDING, "Bip01", "d:/ymir work/effect/hit/blow_poison/bleeding_loop.mse") ## 출혈
	...
	chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+chr.AFFECT_STUN, "Bip01 Head", "d:/ymir work/effect/etc/stun/stun_loop.mse")
	chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+chr.AFFECT_DUNGEON_READY, "", "d:/ymir work/effect/etc/ready/ready.mse")
	#chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+chr.AFFECT_BUILDING_CONSTRUCTION_SMALL, "", "d:/ymir work/guild/effect/10_construction.mse")
	#chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+chr.AFFECT_BUILDING_CONSTRUCTION_LARGE, "", "d:/ymir work/guild/effect/20_construction.mse")
	#chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+chr.AFFECT_BUILDING_UPGRADE, "", "d:/ymir work/guild/effect/20_upgrade.mse")
	chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+chr.AFFECT_CHEONGEUN, "", "d:/ymir work/pc/warrior/effect/gyeokgongjang_loop.mse") ## 천근추 (밑에도 있따-_-)
	chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+chr.AFFECT_GYEONGGONG, "", "d:/ymir work/pc/assassin/effect/gyeonggong_loop.mse") ## 자객 - 경공
	chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+chr.AFFECT_GWIGEOM, "Bip01 R Finger2", "d:/ymir work/pc/sura/effect/gwigeom_loop.mse")
	chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+chr.AFFECT_GONGPO, "", "d:/ymir work/pc/sura/effect/fear_loop.mse") ## 수라 - 공포
	chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+chr.AFFECT_JUMAGAP, "", "d:/ymir work/pc/sura/effect/jumagap_loop.mse") ## 수라 - 주마갑
	chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+chr.AFFECT_HOSIN, "", "d:/ymir work/pc/shaman/effect/3hosin_loop.mse") ## 무당 - 호신
	chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+chr.AFFECT_BOHO, "", "d:/ymir work/pc/shaman/effect/boho_loop.mse") ## 무당 - 보호
	chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+chr.AFFECT_KWAESOK, "", "d:/ymir work/pc/shaman/effect/10kwaesok_loop.mse") ## 무당 - 쾌속
	chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+chr.AFFECT_HEUKSIN, "", "d:/ymir work/pc/sura/effect/heuksin_loop.mse")
	chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+chr.AFFECT_MUYEONG, "", "d:/ymir work/pc/sura/effect/muyeong_loop.mse")

	if app.ENABLE_BALANCE_IMPROVING:
		chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+chr.AFFECT_FIRE, "Bip01", "d:/ymir work/effect/hit/hwayeom_loop_1.mse")
	else:
		chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+chr.AFFECT_FIRE, "Bip01", "d:/ymir work/effect/hit/blow_flame/flame_loop.mse")

	chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+chr.AFFECT_GICHEON, "Bip01 R Hand", "d:/ymir work/pc/shaman/effect/6gicheon_hand.mse")
	chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+chr.AFFECT_JEUNGRYEOK, "Bip01 L Hand", "d:/ymir work/pc/shaman/effect/jeungryeok_hand.mse")
	...
	chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+chr.AFFECT_BLUE_POSSESSION, "", "d:/ymir work/pc3/common/effect/gyeokgongjang_loop_w.mse")

	chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+chr.AFFECT_PABEOP, "Bip01 Head", "d:/ymir work/pc/sura/effect/pabeop_loop.mse")
	chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+chr.AFFECT_FALLEN_CHEONGEUN, "", "d:/ymir work/pc/warrior/effect/gyeokgongjang_loop.mse") ## 천근추 (Fallen)
	## 34 Polymoph
	...
	#if app.ENABLE_BATTLE_FIELD:
	#	chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+chr.AFFECT_TARGET_VICTIM, "", "d:/Ymir Work/effect/etc/direction/direction_land_dragonroom.mse")
	...
	chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+4, "PART_WEAPON", "D:/ymir work/pc/common/effect/sword/sword_7th.mse")
	## BOW
	...
	chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+8, "PART_WEAPON_LEFT", "D:/ymir work/pc/common/effect/sword/sword_7th_b.mse")
	## FAN
	...
	chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+12, "PART_WEAPON", "D:/ymir work/pc/common/effect/sword/sword_7th_f.mse")
	## DEGER RIGHT
	...
	chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+16, "PART_WEAPON", "D:/ymir work/pc/common/effect/sword/sword_7th_s.mse")
	## DEGER LEFT
	...
	chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+20, "PART_WEAPON_LEFT", "D:/ymir work/pc/common/effect/sword/sword_7th_s.mse")

	## 수인족 추가
	## CLAW RIGHT
	chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+21, "PART_WEAPON", "D:/ymir work/pc/common/effect/sword/sword_7_w.mse")
	chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+22, "PART_WEAPON", "D:/ymir work/pc/common/effect/sword/sword_8_w.mse")
	chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+23, "PART_WEAPON", "D:/ymir work/pc/common/effect/sword/sword_9_w.mse")
	chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+24, "PART_WEAPON", "D:/ymir work/pc/common/effect/sword/sword_7th_w.mse")
	## CLAW LEFT
	...
	chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+28, "PART_WEAPON_LEFT", "D:/ymir work/pc/common/effect/sword/sword_7th_w.mse")

	## BODY
	chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+29, "Bip01", "D:/ymir work/pc/common/effect/armor/armor_7.mse")
	chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+30, "Bip01", "D:/ymir work/pc/common/effect/armor/armor_8.mse")
	chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+31, "Bip01", "D:/ymir work/pc/common/effect/armor/armor_9.mse")
	chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+32, "Bip01", "D:/ymir work/pc/common/effect/armor/armor_7th_01.mse")
	## BODY SPECIAL
	chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+33, "Bip01", "D:/ymir work/pc/common/effect/armor/armor-4-2-1.mse")
	chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+34, "Bip01", "D:/ymir work/pc/common/effect/armor/armor-4-2-2.mse")
	chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+35, "Bip01", "D:/ymir work/pc/common/effect/armor/armor-5-1.mse")
	chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+36, "Bip01", "D:/ymir work/pc/common/effect/armor/armor-5_jin.mse")

	if app.ENABLE_ACCE_COSTUME_SYSTEM:
		chrmgr.RegisterEffect(chrmgr.EFFECT_ACCE_BACK, "Bip01", "D:/ymir work/pc/common/effect/armor/acc_01.mse")

	if app.ENABLE_REFINE_ELEMENT_SYSTEM:
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED_ELEMENT + (chrmgr.REFINE_ELEMENT_CATEGORY_ELECT * chrmgr.EFFECT_REFINE_ELEMENT_WEAPON_MAX) + chrmgr.EFFECT_REFINE_ELEMENT_WEAPON_SWORD, "", "D:/ymir work/pc/common/effect/sword/element01_electric.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED_ELEMENT + (chrmgr.REFINE_ELEMENT_CATEGORY_ELECT * chrmgr.EFFECT_REFINE_ELEMENT_WEAPON_MAX) + chrmgr.EFFECT_REFINE_ELEMENT_WEAPON_BOW, "", "D:/ymir work/pc/common/effect/sword/element01_electric_b.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED_ELEMENT + (chrmgr.REFINE_ELEMENT_CATEGORY_ELECT * chrmgr.EFFECT_REFINE_ELEMENT_WEAPON_MAX) + chrmgr.EFFECT_REFINE_ELEMENT_WEAPON_FAN, "", "D:/ymir work/pc/common/effect/sword/element01_electric_f.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED_ELEMENT + (chrmgr.REFINE_ELEMENT_CATEGORY_ELECT * chrmgr.EFFECT_REFINE_ELEMENT_WEAPON_MAX) + chrmgr.EFFECT_REFINE_ELEMENT_WEAPON_DEGER, "", "D:/ymir work/pc/common/effect/sword/element01_electric_s.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED_ELEMENT + (chrmgr.REFINE_ELEMENT_CATEGORY_ELECT * chrmgr.EFFECT_REFINE_ELEMENT_WEAPON_MAX) + chrmgr.EFFECT_REFINE_ELEMENT_WEAPON_CLAW, "", "D:/ymir work/pc/common/effect/sword/element01_electric_w.mse")

		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED_ELEMENT + (chrmgr.REFINE_ELEMENT_CATEGORY_FIRE * chrmgr.EFFECT_REFINE_ELEMENT_WEAPON_MAX) + chrmgr.EFFECT_REFINE_ELEMENT_WEAPON_SWORD, "", "D:/ymir work/pc/common/effect/sword/element02_fire.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED_ELEMENT + (chrmgr.REFINE_ELEMENT_CATEGORY_FIRE * chrmgr.EFFECT_REFINE_ELEMENT_WEAPON_MAX) + chrmgr.EFFECT_REFINE_ELEMENT_WEAPON_BOW, "", "D:/ymir work/pc/common/effect/sword/element02_fire_b.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED_ELEMENT + (chrmgr.REFINE_ELEMENT_CATEGORY_FIRE * chrmgr.EFFECT_REFINE_ELEMENT_WEAPON_MAX) + chrmgr.EFFECT_REFINE_ELEMENT_WEAPON_FAN, "", "D:/ymir work/pc/common/effect/sword/element02_fire_f.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED_ELEMENT + (chrmgr.REFINE_ELEMENT_CATEGORY_FIRE * chrmgr.EFFECT_REFINE_ELEMENT_WEAPON_MAX) + chrmgr.EFFECT_REFINE_ELEMENT_WEAPON_DEGER, "", "D:/ymir work/pc/common/effect/sword/element02_fire_s.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED_ELEMENT + (chrmgr.REFINE_ELEMENT_CATEGORY_FIRE * chrmgr.EFFECT_REFINE_ELEMENT_WEAPON_MAX) + chrmgr.EFFECT_REFINE_ELEMENT_WEAPON_CLAW, "", "D:/ymir work/pc/common/effect/sword/element02_fire_w.mse")

		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED_ELEMENT + (chrmgr.REFINE_ELEMENT_CATEGORY_ICE * chrmgr.EFFECT_REFINE_ELEMENT_WEAPON_MAX) + chrmgr.EFFECT_REFINE_ELEMENT_WEAPON_SWORD, "", "D:/ymir work/pc/common/effect/sword/element03_ice.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED_ELEMENT + (chrmgr.REFINE_ELEMENT_CATEGORY_ICE * chrmgr.EFFECT_REFINE_ELEMENT_WEAPON_MAX) + chrmgr.EFFECT_REFINE_ELEMENT_WEAPON_BOW, "", "D:/ymir work/pc/common/effect/sword/element03_ice_b.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED_ELEMENT + (chrmgr.REFINE_ELEMENT_CATEGORY_ICE * chrmgr.EFFECT_REFINE_ELEMENT_WEAPON_MAX) + chrmgr.EFFECT_REFINE_ELEMENT_WEAPON_FAN, "", "D:/ymir work/pc/common/effect/sword/element03_ice_f.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED_ELEMENT + (chrmgr.REFINE_ELEMENT_CATEGORY_ICE * chrmgr.EFFECT_REFINE_ELEMENT_WEAPON_MAX) + chrmgr.EFFECT_REFINE_ELEMENT_WEAPON_DEGER, "", "D:/ymir work/pc/common/effect/sword/element03_ice_s.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED_ELEMENT + (chrmgr.REFINE_ELEMENT_CATEGORY_ICE * chrmgr.EFFECT_REFINE_ELEMENT_WEAPON_MAX) + chrmgr.EFFECT_REFINE_ELEMENT_WEAPON_CLAW, "", "D:/ymir work/pc/common/effect/sword/element03_ice_w.mse")

		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED_ELEMENT + (chrmgr.REFINE_ELEMENT_CATEGORY_WIND * chrmgr.EFFECT_REFINE_ELEMENT_WEAPON_MAX) + chrmgr.EFFECT_REFINE_ELEMENT_WEAPON_SWORD, "", "D:/ymir work/pc/common/effect/sword/element04_wind.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED_ELEMENT + (chrmgr.REFINE_ELEMENT_CATEGORY_WIND * chrmgr.EFFECT_REFINE_ELEMENT_WEAPON_MAX) + chrmgr.EFFECT_REFINE_ELEMENT_WEAPON_BOW, "", "D:/ymir work/pc/common/effect/sword/element04_wind_b.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED_ELEMENT + (chrmgr.REFINE_ELEMENT_CATEGORY_WIND * chrmgr.EFFECT_REFINE_ELEMENT_WEAPON_MAX) + chrmgr.EFFECT_REFINE_ELEMENT_WEAPON_FAN, "", "D:/ymir work/pc/common/effect/sword/element04_wind_f.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED_ELEMENT + (chrmgr.REFINE_ELEMENT_CATEGORY_WIND * chrmgr.EFFECT_REFINE_ELEMENT_WEAPON_MAX) + chrmgr.EFFECT_REFINE_ELEMENT_WEAPON_DEGER, "", "D:/ymir work/pc/common/effect/sword/element04_wind_s.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED_ELEMENT + (chrmgr.REFINE_ELEMENT_CATEGORY_WIND * chrmgr.EFFECT_REFINE_ELEMENT_WEAPON_MAX) + chrmgr.EFFECT_REFINE_ELEMENT_WEAPON_CLAW, "", "D:/ymir work/pc/common/effect/sword/element04_wind_w.mse")

		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED_ELEMENT + (chrmgr.REFINE_ELEMENT_CATEGORY_EARTH * chrmgr.EFFECT_REFINE_ELEMENT_WEAPON_MAX) + chrmgr.EFFECT_REFINE_ELEMENT_WEAPON_SWORD, "", "D:/ymir work/pc/common/effect/sword/element05_daeji.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED_ELEMENT + (chrmgr.REFINE_ELEMENT_CATEGORY_EARTH * chrmgr.EFFECT_REFINE_ELEMENT_WEAPON_MAX) + chrmgr.EFFECT_REFINE_ELEMENT_WEAPON_BOW, "", "D:/ymir work/pc/common/effect/sword/element05_daeji_b.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED_ELEMENT + (chrmgr.REFINE_ELEMENT_CATEGORY_EARTH * chrmgr.EFFECT_REFINE_ELEMENT_WEAPON_MAX) + chrmgr.EFFECT_REFINE_ELEMENT_WEAPON_FAN, "", "D:/ymir work/pc/common/effect/sword/element05_daeji_f.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED_ELEMENT + (chrmgr.REFINE_ELEMENT_CATEGORY_EARTH * chrmgr.EFFECT_REFINE_ELEMENT_WEAPON_MAX) + chrmgr.EFFECT_REFINE_ELEMENT_WEAPON_DEGER, "", "D:/ymir work/pc/common/effect/sword/element05_daeji_s.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED_ELEMENT + (chrmgr.REFINE_ELEMENT_CATEGORY_EARTH * chrmgr.EFFECT_REFINE_ELEMENT_WEAPON_MAX) + chrmgr.EFFECT_REFINE_ELEMENT_WEAPON_CLAW, "", "D:/ymir work/pc/common/effect/sword/element05_daeji_w.mse")

		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED_ELEMENT + (chrmgr.REFINE_ELEMENT_CATEGORY_DARK * chrmgr.EFFECT_REFINE_ELEMENT_WEAPON_MAX) + chrmgr.EFFECT_REFINE_ELEMENT_WEAPON_SWORD, "", "D:/ymir work/pc/common/effect/sword/element06_dark.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED_ELEMENT + (chrmgr.REFINE_ELEMENT_CATEGORY_DARK * chrmgr.EFFECT_REFINE_ELEMENT_WEAPON_MAX) + chrmgr.EFFECT_REFINE_ELEMENT_WEAPON_BOW, "", "D:/ymir work/pc/common/effect/sword/element06_dark_b.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED_ELEMENT + (chrmgr.REFINE_ELEMENT_CATEGORY_DARK * chrmgr.EFFECT_REFINE_ELEMENT_WEAPON_MAX) + chrmgr.EFFECT_REFINE_ELEMENT_WEAPON_FAN, "", "D:/ymir work/pc/common/effect/sword/element06_dark_f.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED_ELEMENT + (chrmgr.REFINE_ELEMENT_CATEGORY_DARK * chrmgr.EFFECT_REFINE_ELEMENT_WEAPON_MAX) + chrmgr.EFFECT_REFINE_ELEMENT_WEAPON_DEGER, "", "D:/ymir work/pc/common/effect/sword/element06_dark_s.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED_ELEMENT + (chrmgr.REFINE_ELEMENT_CATEGORY_DARK * chrmgr.EFFECT_REFINE_ELEMENT_WEAPON_MAX) + chrmgr.EFFECT_REFINE_ELEMENT_WEAPON_CLAW, "", "D:/ymir work/pc/common/effect/sword/element06_dark_w.mse")
	...
	if app.ENABLE_CONQUEROR_LEVEL:
		effect.RegisterIndexedFlyData(effect.FLY_ILGWANGPYO_NORMAL, effect.INDEX_FLY_TYPE_NORMAL, "d:/ymir work/pc/assassin/effect/ilgangpyo_1.msf")
		effect.RegisterIndexedFlyData(effect.FLY_ILGWANGPYO_MASTER, effect.INDEX_FLY_TYPE_NORMAL, "d:/ymir work/pc/assassin/effect/ilgangpyo_2.msf")
		effect.RegisterIndexedFlyData(effect.FLY_ILGWANGPYO_GRAND_MASTER, effect.INDEX_FLY_TYPE_NORMAL, "d:/ymir work/pc/assassin/effect/ilgangpyo_3.msf")
		effect.RegisterIndexedFlyData(effect.FLY_ILGWANGPYO_PERFECT_MASTER, effect.INDEX_FLY_TYPE_NORMAL, "d:/ymir work/pc/assassin/effect/ilgangpyo_4.msf")
		effect.RegisterIndexedFlyData(effect.FLY_CONQUEROR_EXP, effect.INDEX_FLY_TYPE_NORMAL, "d:/ymir work/effect/etc/gathering/ga_piece_orange_small.msf")
	...
	net.RegisterEmoticonType(0)

	chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON + 1, "", EmoticonStr + "money.mse")
	net.RegisterEmoticonType(1)

	chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON + 2, "", EmoticonStr + "happy.mse")
	net.RegisterEmoticonType(2)

	chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON + 3, "", EmoticonStr + "love_s.mse")
	net.RegisterEmoticonType(3)

	chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON + 4, "", EmoticonStr + "love_l.mse")
	net.RegisterEmoticonType(4)

	chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON + 5, "", EmoticonStr + "angry.mse")
	net.RegisterEmoticonType(5)

	chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON + 6, "", EmoticonStr + "aha.mse")
	net.RegisterEmoticonType(6)

	chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON + 7, "", EmoticonStr + "gloom.mse")
	net.RegisterEmoticonType(7)

	chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON + 8, "", EmoticonStr + "sorry.mse")
	net.RegisterEmoticonType(8)

	chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON + 9, "", EmoticonStr + "!_mix_back.mse")
	net.RegisterEmoticonType(9)

	chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON + 10, "", EmoticonStr + "question.mse")
	net.RegisterEmoticonType(10)

	chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON + 11, "", EmoticonStr + "fish.mse")
	net.RegisterEmoticonType(11)

	if app.ENABLE_EXPRESSING_EMOTION:
		chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON + 12, "", EmoticonStr + "charging.mse")
		net.RegisterEmoticonType(emotion.EMOTION_CHARGING)

		chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON + 13, "", EmoticonStr + "nosay.mse")
		net.RegisterEmoticonType(emotion.EMOTION_NOSAY)

		chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON + 14, "", EmoticonStr + "weather1.mse")
		net.RegisterEmoticonType(emotion.EMOTION_WEATHER_1)

		chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON + 15, "", EmoticonStr + "weather2.mse")
		net.RegisterEmoticonType(emotion.EMOTION_WEATHER_2)

		chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON + 16, "", EmoticonStr + "weather3.mse")
		net.RegisterEmoticonType(emotion.EMOTION_WEATHER_3)

		chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON + 17, "", EmoticonStr + "hungry.mse")
		net.RegisterEmoticonType(emotion.EMOTION_HUNGRY)

		chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON + 18, "", EmoticonStr + "siren.mse")
		net.RegisterEmoticonType(emotion.EMOTION_SIREN)

		chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON + 19, "", EmoticonStr + "letter.mse")
		net.RegisterEmoticonType(emotion.EMOTION_LETTER)

		chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON + 20, "", EmoticonStr + "call.mse")
		net.RegisterEmoticonType(emotion.EMOTION_CALL)

		chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON + 21, "", EmoticonStr + "celebration.mse")
		net.RegisterEmoticonType(emotion.EMOTION_CELEBRATION)

		chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON + 22, "", EmoticonStr + "alcohol.mse")
		net.RegisterEmoticonType(emotion.EMOTION_ALCOHOL)

		chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON + 23, "", EmoticonStr + "busy.mse")
		net.RegisterEmoticonType(emotion.EMOTION_BUSY)

		chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON + 24, "", EmoticonStr + "whirl.mse")
		net.RegisterEmoticonType(emotion.EMOTION_WHIRL)

	if app.ENABLE_FISHING_GAME:
		chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON + 25, "", EmoticonStr + "fish_3.mse")
		net.RegisterEmoticonType(25)
	...
	if app.ENABLE_CONQUEROR_LEVEL:
		chrmgr.RegisterEffect(chrmgr.EFFECT_CHEONUN_INVINCIBILITY, "Bip01", "d:/ymir work/pc/shaman/effect/chunwoon_moojuk.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_CHEONUN_NORMAL, "", "d:/ymir work/pc/shaman/effect/chunwoon_1_target.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_CHEONUN_MASTER, "", "d:/ymir work/pc/shaman/effect/chunwoon_2_target.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_CHEONUN_GRAND_MASTER, "", "d:/ymir work/pc/shaman/effect/chunwoon_3_target.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_CHEONUN_PERFECT_MASTER, "", "d:/ymir work/pc/shaman/effect/chunwoon_4_target.mse")
...
def __LoadGameWolfmanEx(race, path):
	...
	chrmgr.SetMotionRandomWeight(chr.MOTION_MODE_GENERAL, chr.MOTION_WAIT, 0, 50)
	chrmgr.RegisterCacheMotionData(chr.MOTION_MODE_GENERAL, chr.MOTION_WAIT, "wait1.msa", 30)
	chrmgr.RegisterCacheMotionData(chr.MOTION_MODE_GENERAL, chr.MOTION_WAIT, "wait2.msa", 20)
...
if app.ENABLE_SET_ITEM:
	def __LoadSetItemName():
		item.SetPreName(player.SET_ITEM_SET_VALUE_1, localeInfo.TOOLTIP_SET_ITEM_1)
		item.SetPreName(player.SET_ITEM_SET_VALUE_2, localeInfo.TOOLTIP_SET_ITEM_2)
		item.SetPreName(player.SET_ITEM_SET_VALUE_3, localeInfo.TOOLTIP_SET_ITEM_3)
		item.SetPreName(player.SET_ITEM_SET_VALUE_4, localeInfo.TOOLTIP_SET_ITEM_4)
		item.SetPreName(player.SET_ITEM_SET_VALUE_5, localeInfo.TOOLTIP_SET_ITEM_5)
...
if app.ENABLE_SET_ITEM:
	loadGameDataDict["SET_ITEM"] = __LoadSetItemName()
