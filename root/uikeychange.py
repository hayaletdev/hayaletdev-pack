...
class KeyChangeWindow(ui.ScriptWindow):
	def __init__(self, game, interface):
		...
		if app.ENABLE_DSS_KEY_SELECT:
			self.KeySlotMaxOri = self.KeySlotMax
			self.YupColumn3 = 0
			self.KeySlotMax = self.KeySlotMax + 2
		...
		if localeInfo.IsARABIC():
			...
			for i in xrange(self.KeySlotMax):
				...
				if i == 50:
					...
					if app.ENABLE_DSS_KEY_SELECT:
						self.YupColumn3 = self.Yup
					self.Yup = 0

				if app.ENABLE_DSS_KEY_SELECT and i == self.KeySlotMaxOri:
					self.Xup = self.baseXArabic - (180 * 2 + 30)
					self.Yup = self.YupColumn3
	...
	def Open(self):
		...
		player.IsOpenKeySettingWindow(1)
	...
	def KeyChangeWindowSaveClose(self, isclose):
		if isclose:
			...
			self.Hide()
			self.isloded = 0
			player.IsOpenKeySettingWindow(0)
			for i in xrange(self.KeySlotMax):
	...
	def LoadKeyInfo(self):
		...
		if count > 0:
			...
			if count-1 != self.KeySlotMax:
				...
				if app.ENABLE_EVENT_BANNER:
					if not self.KeyUiInfoDick[64]:
						self.KeyUiInfoDick[66] = app.DIK_E + app.DIK_LCONTROL + self.ADDKEYBUFFERCONTROL

				if app.ENABLE_DSS_KEY_SELECT:
					if not self.KeyUiInfoDick[65]:
						self.KeyUiInfoDick[67] = app.DIK_C + app.DIK_LCONTROL + self.ADDKEYBUFFERCONTROL
					if not self.KeyUiInfoDick[66]:
						self.KeyUiInfoDick[68] = app.DIK_V + app.DIK_LCONTROL + self.ADDKEYBUFFERCONTROL
	...
	## 키 셋팅.
	def SettingKey(self):
		player.KeySettingClear()
		for i in xrange(self.KeySlotMax):
			player.KeySetting(self.KeyUiInfoDick[i],self.KeyFunctionInfo[i])
	...
	def __BuildKeyInfo(self, fileable):
		...
		if app.ENABLE_EVENT_BANNER:
			KeyUiInfoDick[66] = app.DIK_E + app.DIK_LCONTROL + self.ADDKEYBUFFERCONTROL

		if app.ENABLE_DSS_KEY_SELECT:
			KeyUiInfoDick[67] = app.DIK_C + app.DIK_LCONTROL + self.ADDKEYBUFFERCONTROL
			KeyUiInfoDick[68] = app.DIK_V + app.DIK_LCONTROL + self.ADDKEYBUFFERCONTROL
	...
	def __BuildKeyFunction(self):
		...
		## 기본동작
		KeyFunctionInfo[0] = player.KEY_MOVE_UP_1
		KeyFunctionInfo[1] = player.KEY_MOVE_DOWN_1
		KeyFunctionInfo[2] = player.KEY_MOVE_LEFT_1
		KeyFunctionInfo[3] = player.KEY_MOVE_RIGHT_1
		KeyFunctionInfo[4] = player.KEY_CAMERA_ROTATE_POSITIVE_1
		KeyFunctionInfo[5] = player.KEY_CAMERA_ROTATE_NEGATIVE_1
		KeyFunctionInfo[6] = player.KEY_CAMERA_ZOOM_NEGATIVE_1
		KeyFunctionInfo[7] = player.KEY_CAMERA_ZOOM_POSITIVE_1
		KeyFunctionInfo[8] = player.KEY_CAMERA_PITCH_NEGATIVE_1
		KeyFunctionInfo[9] = player.KEY_CAMERA_PITCH_POSITIVE_1
		KeyFunctionInfo[10] = player.KEY_ROOTING_1
		KeyFunctionInfo[11] = player.KEY_ATTACK
		KeyFunctionInfo[12] = player.KEY_RIDEMYHORS
		KeyFunctionInfo[13] = player.KEY_FEEDMYHORS
		KeyFunctionInfo[14] = player.KEY_EMOTION1
		KeyFunctionInfo[15] = player.KEY_EMOTION2
		KeyFunctionInfo[16] = player.KEY_EMOTION3
		KeyFunctionInfo[17] = player.KEY_EMOTION4
		KeyFunctionInfo[18] = player.KEY_AUTO_RUN
		KeyFunctionInfo[19] = player.KEY_MOVE_UP_2
		KeyFunctionInfo[20] = player.KEY_MOVE_DOWN_2
		KeyFunctionInfo[21] = player.KEY_MOVE_LEFT_2
		KeyFunctionInfo[22] = player.KEY_MOVE_RIGHT_2
		KeyFunctionInfo[23] = player.KEY_CAMERA_ROTATE_POSITIVE_2
		KeyFunctionInfo[24] = player.KEY_CAMERA_ROTATE_NEGATIVE_2
		KeyFunctionInfo[25] = player.KEY_CAMERA_ZOOM_NEGATIVE_2
		KeyFunctionInfo[26] = player.KEY_CAMERA_ZOOM_POSITIVE_2
		KeyFunctionInfo[27] = player.KEY_CAMERA_PITCH_NEGATIVE_2
		KeyFunctionInfo[28] = player.KEY_CAMERA_PITCH_POSITIVE_2
		KeyFunctionInfo[29] = player.KEY_ROOTING_2
		KeyFunctionInfo[30] = player.KEY_RIDEHORS
		KeyFunctionInfo[31] = player.KEY_BYEMYHORS
		KeyFunctionInfo[32] = player.KEY_EMOTION5
		KeyFunctionInfo[33] = player.KEY_EMOTION6
		KeyFunctionInfo[34] = player.KEY_EMOTION7
		KeyFunctionInfo[35] = player.KEY_EMOTION8
		KeyFunctionInfo[36] = player.KEY_EMOTION9
		KeyFunctionInfo[37] = player.KEY_NEXT_TARGET
		## 슬롯 단축키
		KeyFunctionInfo[38] = player.KEY_SLOT_1
		KeyFunctionInfo[39] = player.KEY_SLOT_2
		KeyFunctionInfo[40] = player.KEY_SLOT_3
		KeyFunctionInfo[41] = player.KEY_SLOT_4
		KeyFunctionInfo[42] = player.KEY_SLOT_5
		KeyFunctionInfo[43] = player.KEY_SLOT_6
		KeyFunctionInfo[44] = player.KEY_SLOT_7
		KeyFunctionInfo[45] = player.KEY_SLOT_8
		KeyFunctionInfo[46] = player.KEY_SLOT_CHANGE_1
		KeyFunctionInfo[47] = player.KEY_SLOT_CHANGE_2
		KeyFunctionInfo[48] = player.KEY_SLOT_CHANGE_3
		KeyFunctionInfo[49] = player.KEY_SLOT_CHANGE_4
		## 인터페이스
		KeyFunctionInfo[50] = player.KEY_OPEN_STATE
		KeyFunctionInfo[51] = player.KEY_OPEN_SKILL
		KeyFunctionInfo[52] = player.KEY_OPEN_QUEST
		KeyFunctionInfo[53] = player.KEY_OPEN_INVENTORY
		KeyFunctionInfo[54] = player.KEY_OPEN_DDS
		KeyFunctionInfo[55] = player.KEY_OPEN_MINIMAP
		KeyFunctionInfo[56] = player.KEY_OPEN_LOGCHAT
		KeyFunctionInfo[57] = player.KEY_SCROLL_ONOFF
		KeyFunctionInfo[58] = player.KEY_OPEN_GUILD
		KeyFunctionInfo[59] = player.KEY_OPEN_MESSENGER
		KeyFunctionInfo[60] = player.KEY_OPEN_HELP
		KeyFunctionInfo[61] = player.KEY_OPEN_ACTION
		KeyFunctionInfo[62] = player.KEY_PLUS_MINIMAP
		KeyFunctionInfo[63] = player.KEY_MIN_MINIMAP
		KeyFunctionInfo[64] = player.KEY_SCREENSHOT
		KeyFunctionInfo[65] = player.KEY_SHOW_NAME

		#if app.ENABLE_GROWTH_PET_SYSTEM:
		#	KeyFunctionInfo[66] = player.KEY_OPEN_PET#lambda : self.interface.TogglePetInformationWindow()
		#if app.ENABLE_AUTO_SYSTEM:
		#	KeyFunctionInfo[67] = player.KEY_OPEN_AUTO #lambda : self.interface.ToggleAutoWindow
		#if app.ENABLE_MONSTER_CARD:
		#	KeyFunctionInfo[68] = player.KEY_MONSTER_CARD #lambda : self.interface.ToggleMonsterCardWindow
		#if app.ENABLE_PARTY_MATCH:
		#	KeyFunctionInfo[69] = player.KEY_PARTY_MATCH
		if app.ENABLE_EVENT_BANNER:
			KeyFunctionInfo[66] = player.KEY_OPEN_IN_GAME_EVENT

		if app.ENABLE_DSS_KEY_SELECT:
			KeyFunctionInfo[67] = player.KEY_SELECT_DSS_1 #lambda : self.interface.DragonSoulActivate(0)
			KeyFunctionInfo[68] = player.KEY_SELECT_DSS_2 #lambda : self.interface.DragonSoulActivate(1)
