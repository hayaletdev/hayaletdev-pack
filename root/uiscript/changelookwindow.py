	...
	(
		{
			...
			(
				...
				## Slot
				{
					...
					"image" : uiScriptLocale.LOCALE_COMMON_UISCRIPT_PATH + "changelook/ingame_convert.tga",
					...
					(
						{
							...
							"slot" : (
								{"index":0, "x":26, "y":20, "width":31, "height":96},  # ¸ÞÀÎ
								{"index":1, "x":125, "y":20, "width":31, "height":96},  # ¼­ºê
							),
						},
						{
							...
							"slot" : (
								{"index":0, "x":1, "y":1, "width":31, "height":31},  # À¯·á¾ÆÀÌÅÛ
							),
						},
					),
				},
