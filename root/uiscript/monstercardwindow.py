					...
					## 모델 뷰
					{
						...
						(
							...
							## model view bg
							{
								...
								"index" : app.RENDER_TARGET_INDEX_ILLUSTRATED,
							},
							## 상 버튼
							{
					...
					## 업적 보너스&모델 목록 맨위에 바
					{
						...
						(
							...
							{ 
								...
								(
									## model view bg
									{ "name" : "model_view_achiev",					"type" : "render_target",	"x" : 0, "y" : 0, "width" : 240, "height" : 306, "index" : app.RENDER_TARGET_INDEX_ILLUSTRATED, },
