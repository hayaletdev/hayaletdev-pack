...
class CreateCharacterWindow(ui.Window):
	...
	def __init__(self, stream):
		...
		self.LEN_JOBLIST = len(self.M2JOBLIST)
	...
	def Open(self):
		...
		pythonScriptLoader.LoadScriptFile( self.dlgBoard, uiScriptLocale.LOCALE_COMMON_UISCRIPT_PATH + "New_CreateCharacterWindow.py" ) 
