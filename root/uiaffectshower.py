...
class AffectShower(ui.Window):
	...
	if app.ENABLE_SET_ITEM:
		...
		AFFECT_DATA_DICT[chr.NEW_AFFECT_SET_ITEM_SET_VALUE_1] = (localeInfo.TOOLTIP_AFFECT_SET_ITEM_1, "d:/ymir work/ui/skill/common/affect/set_bonus.sub")
		AFFECT_DATA_DICT[chr.NEW_AFFECT_SET_ITEM_SET_VALUE_2] = (localeInfo.TOOLTIP_AFFECT_SET_ITEM_2, "d:/ymir work/ui/skill/common/affect/set_bonus.sub")
		AFFECT_DATA_DICT[chr.NEW_AFFECT_SET_ITEM_SET_VALUE_3] = (localeInfo.TOOLTIP_AFFECT_SET_ITEM_3, "d:/ymir work/ui/skill/common/affect/set_bonus.sub")
		AFFECT_DATA_DICT[chr.NEW_AFFECT_SET_ITEM_SET_VALUE_4] = (localeInfo.TOOLTIP_AFFECT_SET_ITEM_4, "d:/ymir work/ui/skill/common/affect/set_bonus.sub")
		AFFECT_DATA_DICT[chr.NEW_AFFECT_SET_ITEM_SET_VALUE_5] = (localeInfo.TOOLTIP_AFFECT_SET_ITEM_5, "d:/ymir work/ui/skill/common/affect/set_bonus.sub")
	...
	# if app.ENABLE_FLOWER_EVENT:
		# AFFECT_DATA_DICT[chr.NEW_AFFECT_FLOWER_EVENT] = ("", "d:/ymir work/ui/skill/common/affect/flower_event.sub")
	...
	if app.ENABLE_CONQUEROR_LEVEL:
		...
		AFFECT_DATA_DICT[chr.NEW_AFFECT_SUNGMA_BONUS] = (localeInfo.TOOLTIP_SUNGMA_ATTR_PRIMIUM, "d:/ymir work/ui/skill/common/affect/sungma_premium_buff.sub")

	if app.ENABLE_YUTNORI_EVENT_FLAG_RENEWAL:
		AFFECT_DATA_DICT[chr.NEW_AFFECT_HALLOWEEN_EVENT] = (localeInfo.TOOLTIP_HALLOWEEN_EVENT_BUFF, "d:/ymir work/ui/skill/common/affect/halloween_bonus.sub")
	...
	if app.ENABLE_ELEMENTAL_DUNGEON:
		AFFECT_DATA_DICT[chr.NEW_AFFECT_CURSE_OF_ELEMENTAL] = (localeInfo.TOOLTIP_CURSE_OF_ELEMENTAL, "d:/ymir work/ui/skill/common/affect/curse_of_elemental.sub")
		...
		AFFECT_DATA_DICT[chr.NEW_AFFECT_POTION_OF_ELEMENTAL] = (localeInfo.TOOLTIP_POTION_OF_ELEMENTAL, "d:/ymir work/ui/skill/common/affect/potion_of_elemental.sub")

	if app.ENABLE_GUILD_DRAGONLAIR_SYSTEM:
		AFFECT_DATA_DICT[chr.NEW_AFFECT_RED_DRAGONLAIR_BUFF] = (localeInfo.TOOLTIP_AFFECT_RED_DRAGONLAIR_BUFF, "d:/ymir work/ui/skill/common/affect/def_grade_down.sub")

	if app.ENABLE_SUMMER_EVENT_ROULETTE:
		AFFECT_DATA_DICT[chr.NEW_AFFECT_LATE_SUMMER_EVENT_BUFF] = (localeInfo.TOOLTIP_AFFECT_LATE_SUMMER_EVENT_BUFF, "d:/ymir work/ui/skill/common/affect/late_summber_buff_affect.sub")
		AFFECT_DATA_DICT[chr.NEW_AFFECT_LATE_SUMMER_EVENT_PRIMIUM_BUFF] = (localeInfo.TOOLTIP_AFFECT_LATE_SUMMER_EVENT_PRIMIUM_BUFF, "d:/ymir work/ui/skill/common/affect/late_summber_primium_buff_affect.sub")

	if app.ENABLE_DEFENSE_WAVE:
		AFFECT_DATA_DICT[chr.NEW_AFFECT_DEFENSEWAVE_LASER] = (localeInfo.TOOLTIP_AFFECT_DEFENSEWAVE_LASER, "d:/ymir work/ui/skill/common/affect/laser.sub")
